    ...
    <section className="blade-bottom-padding-sm">
      <div className="w-container-xl">
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-end my-4">
          ...
          <span className="text-[#0D5001] lg:border-l-2  lg:border-lightDarkGreen lg:p-2 mt-2 cursor-pointer font-extrabold custom-text-md  mr-auto md:mr-0 font-family-helvetica-now">
            ...
            return (
              ...
              >
                <div className="w-full h-full bg-white rounded-md  flex justify-between flex-col p-4 lg:p-6 group-hover:bg-linear-to-b group-hover:from-lightDarkGreen/95  group-hover:to-black group-hover:transition-colors group-hover:duration-300  ">
                  ...
                  <h6  style={{backgroundImage:"linear-gradient(0deg, #199103 0.08%, #072B01 78.01%)"}} className="custom-text-3xl font-family-helvetica-now font-bold  bg-clip-text text-transparent group-hover:text-white ">
                   {ele.percentage}
                  </h6>
